...
\addbibresource{ex_DataAnalysis.bib}%
%
\begin{document}%
\normalsize%
\newpage%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.6\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig1.png}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig1e.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig1a.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig2a.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig3a_monthly.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig3a_yearly.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig1b.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig2b.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig3b_monthly.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig3b_yearly.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig1c.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig2c.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig3c_monthly.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig3c_yearly.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig6.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig7.jpg}%
...
\includegraphics[width=\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig9_GPM-CMRSET-GFZ.jpg}%
\caption{In term of difference}%
\end{subfigure}%
\begin{subfigure}[c]{0.5\textwidth}%
\includegraphics[width=\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig9_GPM-MOD16A2-GFZ.jpg}%
...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/examples/data/area1/fig/fig5.jpg}%
\label{figure:ann3}%
\end{figure}
