...
# ::
#
#     from wateraccounting.Report import credential
#
# .. seealso::
#
...
#         :Example:
#
#             >>> from wateraccounting.Report.credential import Credential
#             >>> password = 'WaterAccounting'
...
#
#             >>> import os
#             >>> from wateraccounting.Report.credential import encrypt_cfg
...
#
#             >>> import os
#             >>> from wateraccounting.Report.credential import decrypt_cfg
#             >>> path = os.path.join(os.getcwd(), 'tests', 'data')
