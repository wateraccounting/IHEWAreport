...
\begin{figure}[H]%
\centering%
\includegraphics[width=0.8\textwidth]{D:/IHEProjects/Public/IHEWAreport/tests/data/area1/fig/fig7.jpg}%
...
\includegraphics[width=\textwidth]{D:/IHEProjects/Public/IHEWAreport/tests/data/area1/fig/fig8_GPM-CMRSET-GFZ.jpg}%
\caption{In term of difference}%
\end{subfigure}%
\begin{subfigure}[c]{0.5\textwidth}%
\includegraphics[width=\textwidth]{D:/IHEProjects/Public/IHEWAreport/tests/data/area1/fig/fig8_GPM-MOD16A2-GFZ.jpg}%
